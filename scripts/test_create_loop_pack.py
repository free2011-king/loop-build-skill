...
class CreateLoopPackTests(unittest.TestCase):
    def test_scaffold_contains_role_boundaries_and_readiness(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("Initial active roles: Loop Manager, Super Assistant / Loop owner, and Demand intake", team_formation)
            ...
            self.assertIn("minimal active role set", candidate_roles)
